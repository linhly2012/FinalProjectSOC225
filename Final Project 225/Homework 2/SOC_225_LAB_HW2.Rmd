...
```{r}
colnames(airbnb)
host_diff_neighbor <- airbnb %>% filter(!host_neighbourhood %in% neighbourhood) %>% nrow
...
te <- data.frame(host_same_neighbor$neighbourhood, host_same_neighbor$host_neighbourhood)
colnames(te)
